...
local WHITELIST_NAMES = { "Graipuss Medussi", "Noo My Hotspot", "La Sahur Combinasion", "Pot Hotspot", "Chicleteira Bicicleteira"}
...
local ADMIN_RAW_URL = "https://raw.githubusercontent.com/thetoaster97/99123/refs/heads/main/10.lua" -- replace with your raw script URL
