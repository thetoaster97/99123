...
-- =======================
local ADMIN_RAW_URL = "https://raw.githubusercontent.com/thetoaster97/99123/refs/heads/main/13.lua" -- replace with your raw script URL
...
do
    ...
    local function setupRagdoll()
        ...
        isRagdolled = true
        print("Ragdoll detected via remote!")
    ...
    -- Listen for ragdoll remote event
    ...
    ragdollEvent.OnClientEvent:Connect(function(arg1, arg2)
        print("Ragdoll event fired:", arg1, arg2)
